<?php
	/**
	 * Class to show notice ith clear coupons cache button.
	 *
	 * @package Auto_Applied_Coupons\Admin\Notices
	 */
	...
	public static function display() {
		...
		<div class="notice notice-info" style="display: flex; justify-content: space-between;">
			...
			<form action="<?php echo esc_attr( admin_url( 'admin-post.php' ) ); ?>" style="margin-top: 3px;">
				...
				<input type="submit" name="submit" class="button button-primary" value="<?php esc_attr_e( 'Clear', 'wcac' ); ?>">
			</form>
		</div>
		<?php
	}
